...
In the third research question we want to know will gender affect the importance students place on environmental issues, 
and we gather answer on a scale of 1-5, with higher number indicating higher importance the student perceive this issue.
...
answers to questions 3 is ordinal/numerical, we adpoted a Kruskal-Qallis test on the sample.
